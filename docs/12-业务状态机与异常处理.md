...
本节草案的逐项决策入口见 `20-业务签字决策清单.md`：来源 DEC-SALE-01、开单人与设备 DEC-SALE-02、五个动作时点（含对本草案的修订建议，修订同样标 `待确认`）DEC-SALE-03、收款确认 DEC-SALE-04、扫码失败 DEC-SALE-05、退换货（第 5 节）DEC-SALE-06、毛利口径 DEC-SALE-07。本状态机保持 `待业务签字`。
...
- 待确认：盘点期间是否允许销售（销售模块上线前无实际影响）、复盘次数上限、盘亏后报损/找回单据流程、盘盈补录流程、差异审批分级。逐项决策入口见 `20-业务签字决策清单.md`：报损 DEC-EXC-01、找回 DEC-EXC-02、盘盈补录 DEC-EXC-03、串仓修正 DEC-EXC-04、调拨差异闭环 DEC-EXC-05、盘点期间销售 DEC-EXC-06、复盘上限与差异审批分级 DEC-EXC-07。
