...
export const PLANNED_APIS = [
  ...
  { id: "API-ORG-015", method: "POST", path: "/roles", module: "organization" },
  ...
  { id: "API-ORG-021", method: "POST", path: "/warehouses", module: "organization" },
  { id: "API-ORG-022", method: "PATCH", path: "/warehouses/{id}", module: "organization" },
  ...
  { id: "API-PST-001", method: "GET", path: "/personal-stock/mine", module: "personal-stock" },
  { id: "API-PST-002", method: "GET", path: "/personal-stock/orders", module: "personal-stock" },
  { id: "API-PST-003", method: "POST", path: "/personal-stock/orders", module: "personal-stock" },
  { id: "API-PST-004", method: "GET", path: "/personal-stock/orders/{id}", module: "personal-stock" },
  { id: "API-PST-005", method: "POST", path: "/personal-stock/orders/{id}/submit", module: "personal-stock" },
  { id: "API-PST-006", method: "POST", path: "/personal-stock/orders/{id}/confirm", module: "personal-stock" },
  { id: "API-PST-007", method: "POST", path: "/personal-stock/orders/{id}/cancel", module: "personal-stock" },
...
export const NAV_MODULES = [
  ...
  { id: "personal-stock", name: "个人库存", group: "进销存", route: "/inventory/personal", pageFile: "apps/web/src/app/inventory/personal/page.tsx", apiModule: "personal-stock" },
